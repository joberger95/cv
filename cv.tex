...
\title{Mastère Chef de Projet Systèmes Embarqués option Expert Mécatronique }
\firstname{Jordan}
\familyname{BERGER}
 \address{39 avenue de la république}{17 130 MONTENDRE}
...
\cvitem{Langages}{VHDL(Vivado),C,Python,$\mu$Python,HTML5/CSS3}
...
\cvitem{Electronique}{
        \begin{itemize}%
                ...
                \item Microcontrôleur: série PIC 18F, ARM Cortex M-4, technologie FPGA Xilinx
                \item Servo-moteur
        \end{itemize}}
