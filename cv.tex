...
\title{Mécanicien service rapide}
\firstname{Jordan}
\familyname{BERGER}
 \address{39 cité Tauzin}{33 390 BEGLES}
...
\section{Compétences}
 \cvitem{Sur une voiture}{
        \begin{itemize}%      \item Vidange
        	\item Vidange
        	\item Filtres: huilde/habitacle/gasoil/air
                \item Pneumatique
                \item Bilan Hybride Toyota
                \item Disques, plaquettes
                \item Niveaux liquides
                \item Contrôle des élements de sécurités (joints, rotules,...)
        \end{itemize}}
\cvitem{Divers}{
        \begin{itemize}%
